...
class SplashService @Inject constructor(
    ...
    override suspend fun fetchTimeStage(): TimeStage = withContext(Dispatchers.IO) {
    ...
    override suspend fun fetchDayOfWeek(): DayOfWeek = withContext(Dispatchers.IO) {
    ...
    override suspend fun updatePowerByShowOrHide(showOrHide: Boolean): Unit = withContext(Dispatchers.IO) {
